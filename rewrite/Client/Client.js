 ...
 * @property {import("erlpack")} [erlpack]
 * @property {import("zlib")} [zlib]
 * @property {boolean} [compress]
 * @property {boolean} [forceFetchUsers]
 * @property {number} [guildCreateTimeout]
 * @property {number} [largeThreshold]
 * @property {number} [maxCachedMessages]
 * @property {boolean} [rateLimitAsError]
 * @property {boolean} [disableEveryone]
 * @property {number} [shardCount]
 * @property {number} [shardId]
 * @property {[number, number]} [shard]
 ...
 * @property {boolean} [disableEveryone]
 * @property {{ file: FileResolvable, name: string }} [file]
 */
...
const InternalClient = require("./InternalClient.js");
...
const VoiceConnection = require("../Voice/VoiceConnection.js");
 ...
 * @param {(error: Error, data: D) => R} callback
 * @template D, R
 */
...
class Client extends events.EventEmitter {
	 ...
	 */
		...
		this.options.zlib = options.zlib === undefined ? undefined : options.zlib;
		...
		this.options.erlpack = options.erlpack === undefined ? undefined : options.erlpack;
	 ...
	 * @param {(err: Error, token: string) => any} [callback] callback callback to the method
	 * @example
	 ...
	 * @param {(err: Error) => any} [callback] callback callback to the method
	 * @example
	 ...
	 * @param {(err: Error, msg: Message) => any} [callback] to the method
	 * @example
	 * // sending messages
	 ...
	 * @param {(err: Error) => any} [callback] callback to the method
	 * @example
	 * // deleting messages
	 ...
	 * @param {Array<MessageResolvable>} messages the message to delete
	 * @param {(err: Error) => any} [callback] callback to the method
	 * @example
	 * // deleting messages
	 ...
	 * @param {(err: Error, msg: Message) => any} [callback] callback to the method
	 * @example
	 * // editing messages
	 ...
	 * @param {(err: Error, logs: Array<Message>) => any} [callback] callback to the method
	 * @example
	...
	*/
	 ...
	 */
	pinMessage(message, callback = () => /*err*/{}) {
		return this.internal.pinMessage(message).then(dataCallback(callback), errorCallback(callback));
	}
	 ...
	 */
	unpinMessage(message, callback = () => /*err*/{}) {
		return this.internal.unpinMessage(message).then(dataCallback(callback), errorCallback(callback));
	}

	/**
	 * Gets all pinned messages of a channel.
	 * @param {TextChannelResolvable} channel to get the pins from.
	 * @param {(err: Error, messages: Array<Message>) => any} callback
	 * @example
	 ...
	 * @param {(err: Error, bans: Array<User>) => any} [callback] callback to the method
	 * @example
	 ...
	 * @param {(err: Error, server: Server) => any} [callback] callback to the method.
	 * @example
