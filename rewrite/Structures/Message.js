...
class Message extends Equality {
	constructor(data, channel, client) {
		...
		const mentionData = client.internal.resolver.resolveMentions(data.content, channel);
	...
	delete() {
		return this.client.deleteMessage.apply(this.client, (ArgumentRegulariser.reg)(this, arguments));
	}

	update() {
		return this.client.updateMessage.apply(this.client, (ArgumentRegulariser.reg)(this, arguments));
	}
	...
	reply() {
		return this.client.reply.apply(this.client, (ArgumentRegulariser.reg)(this, arguments));
	}

	replyTTS() {
		return this.client.replyTTS.apply(this.client, (ArgumentRegulariser.reg)(this, arguments));
	}

	pin() {
		return this.client.pinMessage.apply(this.client, (ArgumentRegulariser.reg)(this, arguments));
	}
